...
let s:move_manager["\<kPageUp>"] = { winid -> win_execute(winid, 'noautocmd call clap#navigation#scroll("up")') }
let s:move_manager["\<kPageDown>"] = { winid -> win_execute(winid, 'noautocmd call clap#navigation#scroll("down")') }
